...
class DrawView_CoM_Female : View {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        //Forearm L/R
        canvas.drawCircle((mDrawPoint[3].x+0.4217*(mDrawPoint[4].x - mDrawPoint[3].x)).toFloat(),
            (mDrawPoint[3].y+0.4217*(mDrawPoint[4].y - mDrawPoint[3].y)).toFloat(), circleRadius_CoM, mPaint3)
        canvas.drawCircle((mDrawPoint[6].x+0.4217*(mDrawPoint[7].x - mDrawPoint[6].x)).toFloat(),
            (mDrawPoint[6].y+0.4217*(mDrawPoint[7].y - mDrawPoint[6].y)).toFloat(), circleRadius_CoM, mPaint3)
        canvas.drawText(
            "CoM_Forearm = 0.4217 from elbow", 900.toFloat(),
            50.toFloat(),
            mPaint2
        )

        //Upper arm L/R
        canvas.drawCircle((mDrawPoint[2].x+0.5322*(mDrawPoint[3].x - mDrawPoint[2].x)).toFloat(),
            (mDrawPoint[2].y+0.5322*(mDrawPoint[3].y - mDrawPoint[2].y)).toFloat(), circleRadius_CoM, mPaint3)
        canvas.drawCircle((mDrawPoint[5].x+0.5322*(mDrawPoint[6].x - mDrawPoint[5].x)).toFloat(),
            (mDrawPoint[5].y+0.5322*(mDrawPoint[6].y - mDrawPoint[5].y)).toFloat(), circleRadius_CoM, mPaint3)
        canvas.drawText(
            "CoM_Upper arm = 0.5322 from shoulder", 900.toFloat(),
            85.toFloat(),
            mPaint2
        )

        //Upper leg L/R
        canvas.drawCircle((mDrawPoint[9].x+0.6248*(mDrawPoint[8].x - mDrawPoint[9].x)).toFloat(),
            (mDrawPoint[9].y+0.6248*(mDrawPoint[8].y - mDrawPoint[9].y)).toFloat(), circleRadius_CoM, mPaint3)
        canvas.drawCircle((mDrawPoint[12].x+0.6248*(mDrawPoint[11].x - mDrawPoint[12].x)).toFloat(),
            (mDrawPoint[12].y+0.6248*(mDrawPoint[11].y - mDrawPoint[12].y)).toFloat(), circleRadius_CoM, mPaint3)
        canvas.drawText(
            "CoM_Upper leg = 0.6248 from knee", 900.toFloat(),
            120.toFloat(),
            mPaint2
        )

        //Lower leg L/R
        canvas.drawCircle((mDrawPoint[10].x+0.5928*(mDrawPoint[9].x - mDrawPoint[10].x)).toFloat(),
            (mDrawPoint[10].y+0.5928*(mDrawPoint[9].y - mDrawPoint[10].y)).toFloat(), circleRadius_CoM, mPaint3)
        canvas.drawCircle((mDrawPoint[13].x+0.5928*(mDrawPoint[12].x - mDrawPoint[13].x)).toFloat(),
            (mDrawPoint[13].y+0.5928*(mDrawPoint[12].y - mDrawPoint[13].y)).toFloat(), circleRadius_CoM, mPaint3)
        canvas.drawText(
            "CoM_Lower leg = 0.5928 from knee", 900.toFloat(),
            155.toFloat(),
            mPaint2
        )
